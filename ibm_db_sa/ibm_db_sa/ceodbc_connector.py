...
class ceODBCConnector(Connector):
    ...
    def create_connect_args(self, url):
        ...
        if 'odbc_connect' in keys:
            ...
            if dsn_connection:
                ...
                connectors = []
                driver = keys.pop('driver', self.ceODBC_driver_name)
                if driver is None:
                    util.warn(
    ...
    def initialize(self, connection):
        ...
        _sql_driver_name = dbapi_con.dsn
        ...
        if self.freetds:
            self.freetds_driver_version = dbapi_con.dsn
        ...
        super(ceODBCConnector, self).initialize(connection)

    def _dbapi_version(self):
        if not self.dbapi:
            return ()
        return self._parse_dbapi_version(self.dbapi.dsn)
    ...
    def _get_server_version_info(self, connection):
        ...
        version = []
        r = re.compile('[.\-]')
        for n in r.split(dbapi_con.dsn):
            try:
